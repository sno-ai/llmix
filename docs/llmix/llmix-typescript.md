...
Run MDA CLI before and after the publisher: validate, integrity, sign, verify,
release prepare, publish with LLMix, release finalize, then doctor. The runtime
must pass `signedRoot` options derived from the external trust anchor.
